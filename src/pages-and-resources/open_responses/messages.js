...
const messages = defineMessages({
  ...
  enableFlexPeerGradeHelp: {
    ...
    defaultMessage: 'Flexible peer grading for all open response assessments in the course.',
  },
  enableFlexPeerGradeLink: {
    id: 'course-authoring.pages-resources.ora.flex-peer-grading.link',
    defaultMessage: 'Learn more about flexible peer grading',
  },
});
